...
export default function Contact() {
  ...
  return (
    <motion.div
      ...
      animate="animate"
      exit="exit"
      className="w-full min-h-screen pt-24 pb-12 flex flex-col justify-between"
    >
      {/* HEADER */}
      <section className="px-6 md:px-12 max-w-7xl mx-auto w-full mb-12">
        <span className="text-accentSecondary text-xs uppercase font-mono tracking-widest">// Connection</span>
        <h1 className="font-syne text-4xl md:text-8xl font-black uppercase mt-2 leading-none">
      ...
      <section className="w-full border-t border-white/5 divide-y divide-white/5 my-auto">
      ...
      {/* FOOTER CALLOUT */}
      <section className="px-6 md:px-12 max-w-7xl mx-auto w-full text-center md:text-left mt-12 text-xs text-textSecondary flex flex-col md:flex-row justify-between items-center gap-4 border-t border-white/5 pt-6">
