...
const portfolioData = [
  ...
  },
  {
    ...
    location: 'Manado',
    client: 'Ivanka',
    cover: 'src/assets/graduationpics/ivanka1.webp',
    photos: [
      { src: 'src/assets/graduationpics/ivanka1.webp', caption: 'Morning Brew' },
      { src: 'src/assets/graduationpics/ivanka2.webp', caption: 'Campus Corner' },
    ],
  ...
  },
  {
    ...
    location: 'Manado',
    client: 'Humairah',
    cover: 'src/assets/graduationpics/humairah1.webp',
    photos: [
      { src: 'src/assets/graduationpics/humairah1.webp', caption: 'Close Up' },
      { src: 'src/assets/graduationpics/humairah2.webp', caption: 'Sound Wave' },
      { src: 'src/assets/graduationpics/humairah3.webp', caption: 'Studio Session' },
      { src: 'src/assets/graduationpics/humairah4.webp', caption: 'Studio Session' },
    ],
    team: [
      { id: 1, role: 'Lead Photographer' },
